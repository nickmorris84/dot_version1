...
from digital_operation_twin.config.config_loader import load_yaml, deep_merge
...
from src.digital_operation_twin.pipelines.transforms.quality import DataQualityService


class EventListPreparationService:
    ...
    def to_records(self) -> "EventListPreparationService":
